...
public class WordsThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCelebrity = (EditText) findViewById(R.id.celebrity);
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mAdjective1.getText().length() == 0||mAdjective2.getText().length() == 0
                        ...
                        ||mVerb.getText().length() == 0|| mCelebrity.getText().length() == 0) {
                    Toast toast = Toast.makeText(getApplicationContext(), "Please fill all fields",
                            Toast.LENGTH_SHORT);
                    toast.show();
                } else {
                    Intent finalScreen = new Intent(WordsThreeActivity.this, ResultsThreeActivity.class);
                    ...
                    finalScreen.putExtra("CELEB", mCelebrity.getText().toString());
